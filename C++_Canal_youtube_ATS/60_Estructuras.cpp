/* Realizar un programa que lea un arreglo de estructuras los datos N empleados de la empresa y que imrima los datos del empleado con mayor y menor salario.-*/
